...
var basic_level_scene = preload("res://basic_level.tscn")

@onready var main_menu = $UI/Menu
...
func _ready():
	...
	main_menu.pressed_start.connect(start_game)


func start_game() -> void:
	main_menu.hide()
	sub_viewport.add_child(basic_level_scene.instantiate())
